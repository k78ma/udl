...
D_i, D_k, D_o = 10, 40, 1 # D_o = 1 for single binary classification
...
# choose binary cross entropy loss criterion
...
y = torch.randint(0, 2, (100, D_o)).float() # Low exclusive, high inclusive so generates 0 and 1
